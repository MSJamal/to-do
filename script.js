...
class UIManager {
  ...
  handleAddTodo() {
    ...
    if (task === "") {
      ...
      this.showAlertMessage("Task is added successfully", "success");
    }
  }
...
handleEditTodo(id) {
  ...
  if (todo) {
    ...
    const handleUpdate = () => {
      ...
      this.showAlertMessage("Todo is updated successfully", "success");
      this.showAllTodos();
...
handleDeleteTodo(id) {
this.todoManager.deleteTodo(id);
this.showAlertMessage("Todo has been deleted successfully", "success");
this.showAllTodos();
}
